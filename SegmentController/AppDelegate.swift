...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setNavigationBar(_ nav: UINavigationController) {
        ...
        nav.navigationBar.titleTextAttributes = ([NSFontAttributeName: UIFont.systemFont(ofSize: nav.view.frame.size.height * 0.04), NSForegroundColorAttributeName: UIColor.black])
    }
